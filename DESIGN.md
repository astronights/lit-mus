...
| 6b | Detail questions must fail the "delete the book" test (prompt 2026-08-08.3) | Pushing answers *outward* so they mean something to a non-reader had an escape hatch: pure general knowledge with the book as a pretext. "Which society, of which Mauriac was a member, awards a prize named after it?" never mentions the book and is answerable by someone who has never heard of it. The answer looks out; the question must look at the book. |
